...
# 2. 모델
densenet121=DenseNet121(weights='imagenet', include_top=False, input_shape=(32, 32, 3)) # 14,714,688
...
modelpath='./model/densenet121-{epoch:02d}-{val_loss:.4f}.hdf5'
