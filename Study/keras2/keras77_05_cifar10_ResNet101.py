...
# 2. 모델
resnet101=ResNet101(weights='imagenet', include_top=False, input_shape=(32, 32, 3)) # 14,714,688
...
modelpath='./model/resnet101-{epoch:02d}-{val_loss:.4f}.hdf5'
