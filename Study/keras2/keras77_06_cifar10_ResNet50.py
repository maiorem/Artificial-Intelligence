...
# 2. 모델
resnet50=ResNet50(weights='imagenet', include_top=False, input_shape=(32, 32, 3)) # 14,714,688
...
modelpath='./model/resnet50-{epoch:02d}-{val_loss:.4f}.hdf5'
